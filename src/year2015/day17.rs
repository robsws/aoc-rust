...
pub fn part1(input_file_path: &str) {
    ...
    let combos = container_combos_for_amount(containers, 150);
    println!("{}", combos);
}
...
fn container_combos_for_amount(containers: Vec<i32>, total: i32) -> i32 {
    ...
    for i in 0..containers.len() {
        ...
        combos += container_combos_for_amount(containers_to_recurse, total - containers[i]);
    }
    combos
}